...
const products: Product[] = [
  {
    ...
    prices: [
      { label: 'הטבה למשתמש חדש', price: 'חודש ראשון חינם בלבד', note: 'אחר כך מנוי בתשלום' },
      { label: 'שנתי', price: '₪39.90 / חודש', note: 'או ₪49.90 במסלול חודשי', highlight: true },
    ],
    includes: [
  ...
  },
  {
    ...
    includes: [
      ...
      'גישת Lifetime ל־TF Tracker ודוח התקדמות חודשי',
    ],
    valueStack: {
      items: [
    ...
    marketComparison:
      'אצל רוב הקולגות שלי ליווי מרחוק במבנה דומה עולה ₪6,000-8,000 ל־3 חודשים, בלי אפליקציה ובלי רצף נתונים. כאן זה ₪4,500, עם גישת Lifetime ל־TF Tracker.',
  ...
  },
  {
    ...
    includes: [
      ...
      'דוח התקדמות חודשי וגישת Lifetime ל־TF Tracker',
    ],
    valueStack: {
      items: [
