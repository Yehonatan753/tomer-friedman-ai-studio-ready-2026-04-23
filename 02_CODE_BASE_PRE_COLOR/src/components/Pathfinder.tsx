...
function calculateResult(answers: Record<string, string>) {
  ...
  if (answers.q7 === 'budget-entry') return {
    ...
    points: ['חודש ראשון חינם בלבד ואז ₪49.90 חודשי או ₪39.90 במסלול שנתי', 'אחרי ייעוץ טלפוני: 3 חודשים חינם', 'אפשר להתקדם אחר כך בלי לאבד נתונים'],
  ...
  if (score >= 2) return {
    ...
    points: ['עבודה צמודה בקליניקה / אונליין לפי התאמה', 'מדידות והרכב גוף מלאים', 'זמינות יומיומית וגישת Lifetime לאפליקציה'],
  ...
  if (score >= -1) return {
    ...
    points: ['תוכנית מותאמת אישית', 'מעקב שבועי מרחוק', 'עצמאות בביצוע', 'גישת Lifetime לאפליקציית המעקב'],
