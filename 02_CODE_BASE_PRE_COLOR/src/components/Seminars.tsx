    ...
    <section id="seminars" className="py-32 px-6 md:px-16 lg:px-24 bg-bg relative border-y border-foreground/5">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="bg-surface border border-energy/20 rounded-[2rem] p-10 md:p-16 relative overflow-hidden text-center shadow-[0_0_50px_rgba(28,141,255,0.05)]"
        >
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <h3 className="font-heading font-black text-3xl md:text-5xl mb-6 text-foreground">
              סדנאות פרונטליות - <span className="text-transparent bg-clip-text bg-gradient-to-r from-energy to-blue-300">סדרת 2026</span>
            </h3>
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button type="submit" className="btn-magnetic bg-energy text-foreground py-4 px-8 rounded-full font-bold whitespace-nowrap shadow-[0_10px_30px_-10px_rgba(28,141,255,0.4)]">
                הצטרף לרשימה
              </button>
            </form>
          </div>
