...
מוצרים ומחירים:
1. TF Tracker: מוצר כניסה דיגיטלי. חודש ראשון חינם בלבד למשתמש חדש; אחר כך ₪49.90 חודשי או ₪39.90 לחודש במסלול שנתי. אחרי ייעוץ טלפוני מקבלים 3 חודשים חינם. לקוחות תהליך אונליין/פרונטלי מקבלים גישת Lifetime לאפליקציה כחלק מהליווי.
...
function fallbackAnswer(lastUserMessage: string) {
  ...
  if (text.includes('מחיר') || text.includes('כמה') || text.includes('עלות')) {
    return 'המחירים המרכזיים: TF Tracker עם חודש ראשון חינם בלבד ואז ₪49.90 חודשי או ₪39.90 שנתי; אחרי ייעוץ טלפוני מקבלים 3 חודשים חינם. תהליך אונליין מתחיל מ-₪4,500 ל-3 חודשים וליווי אישי מלא מ-₪9,000 ל-3 חודשים, ושניהם כוללים גישת Lifetime לאפליקציה. אם תגיד לי מה המטרה שלך ומה רמת הליווי שאתה רוצה, אפשר לכוון אותך למסלול הנכון.';
  }
  ...
  if (text.includes('אפליק') || text.includes('tracker')) {
    return 'TF Tracker מתאים למי שרוצה מסגרת עצמאית וזולה: אוכל, אימונים, מדידות ומעקב במקום אחד. משתמש חדש מקבל חודש ראשון חינם בלבד ואז מנוי בתשלום; אחרי ייעוץ טלפוני מקבלים 3 חודשים חינם. אם בהמשך עוברים לתהליך אונליין או פרונטלי, מקבלים גישת Lifetime והנתונים ממשיכים איתך.';
  }
